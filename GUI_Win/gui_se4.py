...
def setup_serial_connection():
    try:
        port = detect_device()  # Detect the device
...
class GraphScreen(Screen):
    ...
    def setup_plot(self):
        ...
        try:
            self.ser = setup_serial_connection()  # Use the new function
            if self.ser is None:
                ...
                if line:
                    ...
                    if match:
                        ...
                        try:
                            ...
                            # You can skip the invalid data line or handle it as needed.
                            continue  # Skip this line and continue with the next one
                    else:
                        print(f"Invalid data format: {line}")  # Log if data doesn't match expected format
